        ...
        <div class="container">
            <div class="news__wrapper basic-flex">
                <div class="article__wrapper">
                    ...
                    <span class="article__date basic-flex">{{$post->created_at->format('H:i')}} / {{$post->created_at->format('d.m.Y')}}  @lang('words.Views'):{{$post->view}}</span>
                ...
                <div class="related-news">
                    <h3 class="related-news__title">@lang('words.tema')</h3>
